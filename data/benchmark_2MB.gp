...
# Plot the data
plot \
     "bypass/corrected_gnuplot-1000-50-2.tsv" every ::2 using 2:5 title "bypass" with points, \
     "dummy/corrected_gnuplot-1000-50-2.tsv" every ::2 using 2:5 title "dummy" with points, \
