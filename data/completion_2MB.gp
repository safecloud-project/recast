...
plot \
     "bypass/completion-1000-50-2.csv" every ::2 using 2:1 smooth sbezier with lines title "bypass", \
     "dummy/completion-1000-50-2.csv" every ::2 using 2:1 smooth sbezier with lines title "dummy", \
