...
set output "local_nodes_entangled_fuse.eps"
load "styles.inc"
set size 1,0.65
set bmargin 3
set tmargin 2
set lmargin 9
set rmargin 5
set title "Local Redis cluster, Entanglement Fuse, RS (10,4)" offset 0,-0.5
...
!epstopdf "local_nodes_entangled_fuse.eps"
!rm "local_nodes_entangled_fuse.eps"
quit
