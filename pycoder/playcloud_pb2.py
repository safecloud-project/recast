...
_STRIP = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='Strip.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='index', full_name='Strip.index', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data', full_name='Strip.data', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='checksum', full_name='Strip.checksum', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='type', full_name='Strip.type', index=4,
